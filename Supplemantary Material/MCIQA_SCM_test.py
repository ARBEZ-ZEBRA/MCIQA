...
class QwenPixelCFModel(nn.Module):
    ...
    def forward(self, pixel_values, grid_thw, weight_maps, results):
        ...
        #pixel_score_map = torch.ones_like(pixel_score_map).to("cuda")
...
def test():
    ...
    checkpoint_path = "best_scm_qwen.pth"
    test_img_dir = 'MCIQA_2K'
    test_json = 'MCIQA_2K_SCM_MOS.json'
    output_dir = 'QWEN_SCM_result'
    weight_folder = 'MCIQA_2K_SCM_MASK'
    os.makedirs(output_dir, exist_ok=True)
    test_result_json = 'MCIQA_2K_SCM_MOS.json'
    ...
    with open("MCIQA_2K_SCM_result.json", 'w', encoding='utf-8') as f:
